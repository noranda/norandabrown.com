          ...
          <Typography component="div" my={2} variant="h6">
            <Stack spacing={2}>
              ...
              <Typography component="div">
                ...
                Massachusetts, where I finally decided to settle down. I&apos;m a trained{' '}
                <Highlight>geologist</Highlight> and <Highlight>computer scientist</Highlight> having studied rocks and
                volcanoes in Maine, Hawaii, New Zealand, and Venus (remotely). I interned at Wellesley College, MIT, and
                NASA JPL, working with world famous geoscientists.
              </Typography>
