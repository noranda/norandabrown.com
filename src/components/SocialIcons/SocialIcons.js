...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/noranda" style={ { color: colorPrimary } }>
          <FontAwesomeIcon icon={['fab', 'github']} />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/NorandaBrown" style={ { color: colorPrimary } }>
          <FontAwesomeIcon icon={['fab', 'twitter']} />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/story/noranda" style={ { color: colorPrimary } }>
          <FontAwesomeIcon icon={['fab', 'stack-overflow']} />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/noranda" style={ { color: colorPrimary } }>
          <FontAwesomeIcon icon={['fab', 'linkedin']} />
        </a>

        <a target="_blank" rel="noopener noreferrer" href="https://medium.com/@noranda" style={ { color: colorPrimary } }>
          <FontAwesomeIcon icon={['fab', 'medium']} />
        </a>

        <a className="devto" target="_blank" rel="noopener noreferrer" href="https://dev.to/noranda">
