...
const PopoverRoot = ({...props}: React.ComponentProps<typeof PopoverPrimitive.Root>) => {
...
const PopoverTitle = ({className, ...props}: React.ComponentProps<'h2'>) => {
  return <h2 className={twMerge('font-medium', className)} data-slot="popover-title" {...props} />;
};
